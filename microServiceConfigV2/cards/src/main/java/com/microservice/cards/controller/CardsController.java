...
import com.microservice.cards.dto.CardsConfigurationDto;
...
public class CardsController {
        ...
        @GetMapping("/fetchcardConfig")
        public ResponseEntity<CardsConfigurationDto> getValuesFromConfig() {
                return ResponseEntity.status(HttpStatus.OK).body(cardsConfigurationDto);
        }
